...
<dt><a href="#module_tree">tree</a></dt>
<dd><p>Functions to work with tree structures.</p>
</dd>
</dl>
...
**See**: [src/exec/async-exec-promisify.ts](src/exec/async-exec-promisify.ts)  
...
## tree
Functions to work with tree structures.
